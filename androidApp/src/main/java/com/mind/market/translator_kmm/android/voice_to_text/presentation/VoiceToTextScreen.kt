...
import com.mind.market.translator_kmm.android.voice_to_text.presentation.components.VoiceRecorderDisplay
import com.mind.market.translator_kmm.voice_to_text.presentation.DisplayState
...
fun VoiceToTextScreen(
        ...
        onResult = { isGranted ->
            onEvent(
                VoiceToTextEvent.PermissionResult(
                    isGranted = isGranted,
                    isPermanentlyDeclined = isGranted.not() && (context as ComponentActivity)
    ...
    LaunchedEffect(recordAudioLauncher) { // ask for permission
            ...
            Column(
                ...
                AnimatedContent(targetState = state.displayState) { displayState ->
                    when (displayState) {
                        ...
                        DisplayState.SPEAKING -> VoiceRecorderDisplay(
